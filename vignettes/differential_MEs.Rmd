...
`FindMarkers`. We use the Mann-Whitney U test, also known as the Wilcoxon signed-rank test, to compare two groups, but other tests can be used at the user's discretion
...
We can visualize the results using the hdWGNCA function `PlotDMEsVolcano`.
