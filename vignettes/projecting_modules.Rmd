...
seurat_query <- readRDS(paste0(data_dir, 'Swarup2021_control_scWGCNA_modpres.rds'))
```
...
We encourage users to explore the projected modules using scWGCNA's various
