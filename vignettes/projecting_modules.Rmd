...
have constructed the co-expression network as in the [hdWGCNA basics](articles/basics_tutorial.html). The main hdWGCNA tutorials have been using the control
