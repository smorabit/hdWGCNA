...
from the scWGCNA experiment using `GetMetacellObject`.
...
constructs a correlation adjacency matrix to infer co-expression
...
Tthe output table from the parameter sweep is stored in the scWGCNA experiment
...
<img src="figures/basic_tutorial/ME_featureplot.png" width="600" height="600">
...
<img src="figures/basic_tutorial/ME_featureplot_scores.png" width="600" height="600">
...
<img src="figures/basic_tutorial/ME_correlogram.png" width="500" height="500">
...
<img src="figures/basic_tutorial/ME_correlation_GGally.png" width="500" height="500">
...
<img src="figures/basic_tutorial/ME_dotplot.png" width="600" height="600">
