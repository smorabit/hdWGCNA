...
After we have set up our Seurat object, the first step in running the scWGCNA pipeine
...
hdWGCNA includes a function `ModuleEigengenes` to compute MEs in the Seurat object
...
out certain technical factors, which we demonstrate below. The following code performs the module eigengene computation harmonizing
...
<img src="figures/basic_tutorial/ME_dotplot.png" width="800" height="800">
...
our other tutorials for downstream analysis of these hdWGCNA results.
