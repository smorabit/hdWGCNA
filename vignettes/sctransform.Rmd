...
This tutorial assumes that you are familiar with the [basics of the hdWGCNA workflow](basic_tutorial.html). This tutorial also assumes that you are familiar with
the [SCTransform R package](https://github.com/satijalab/sctransform) and the [SCTransform methods paper(https://genomebiology.biomedcentral.com/articles/10.1186/s13059-019-1874-1). We generally do
not advise using SCTransform unless you are fully aware of how the method works 
and the underlying assumptions that it makes about gene expression distributions etc.
